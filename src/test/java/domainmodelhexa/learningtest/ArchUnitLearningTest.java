package domainmodelhexa.learningtest;
...
@AnalyzeClasses(packages = "domainmodelhexa.learningtest.archunit")
public class ArchUnitLearningTest  {

    /**
     * Application 클래스를 의존하는 클래스는 application, adapter 에만 존재해야 된다.
     */
    @ArchTest
